...
// Configuration Cell
let motorCell = "MotorTableViewCell"
...
class ViewController: UIViewController {
  ...
  var motorCel:MotorTableViewCell?
...
extension ViewController: UITableViewDelegate, UITableViewDataSource{
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    case motorCell:
      let cell = Bundle.main.loadNibNamed(motorCell, owner: self, options: nil)?.first as! MotorTableViewCell
      motorCel = cell
      return cell
...
extension ViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
  ...
  func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
    motorCel?.motorImageView.image = listMotors[indexPath.row]
  }
}
